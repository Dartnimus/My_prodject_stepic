...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.open()
    click_to_add_basket = ProductPage(browser, browser.current_url)
    click_to_add_basket.should_be_click_add_basket()
    page.solve_quiz_and_get_code()
    click_to_add_basket.should_be_product_page_after_click_add_to_basket()
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        password = "Zz" + str(time.time())
        LoginPage(browser, browser.current_url).register_new_user(email, password)
    ...
    def test_user_can_add_product_to_basket(self, browser):
        ...
        basket.should_be_click_add_basket()
        basket.should_be_product_page_after_click_add_to_basket()
